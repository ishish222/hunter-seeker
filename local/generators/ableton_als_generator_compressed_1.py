...
#        print('Ungzipping xml_1')
    ...
    def change(self):
        prefix = '>Ableton MajorVersion="4" MinorVersion="9.5_326" Creator="Ableton Live 9.5b14" Revision="dd97cfbe7b78bb6353aa5bb2e7d0674b8831d11e" >LiveSet >'
...
#        generated_length = 1000
        generating_length = random.randint(1000, 2000)
#        print('Remaining length:\n{}\n'.format(remaining_length))
#        print('Generating')
        self.data_generated = model.rnn.generate(prefix=prefix, max_gen_length=generating_length, return_as_list=True)[0]
...
#        print('Decoding')
        self.data_decoded = convert_xml(self.data_generated)
