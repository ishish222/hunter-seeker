...
class PE:
    ...
    def parse_export_directory(self, rva, size):
        ...
        for i in range( min( export_dir.NumberOfNames, length_until_eof(export_dir.AddressOfNames)/4) ):
        ...
        for idx in range( min(export_dir.NumberOfFunctions, length_until_eof(export_dir.AddressOfFunctions)/4) ):
