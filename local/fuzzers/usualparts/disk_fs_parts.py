...
def create_saved_disk_autogenerated():
    ...
    options.saved_disk_img = create_temp_drive(options, size=saved_size, name="%s-saved.raw" % common.timestamp2(), label="saved", format_cmd=options.settings.qemu_drive_format)
