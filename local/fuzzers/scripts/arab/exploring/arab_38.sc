...
TracerRegisterReactions(self+0xd8f2,A3:B3,0x103;self+0xd995,B3:A3,0x100)
TracerRegisterReactions(self+0xd95c,A4:B4,0x100;self+0xd9a7,B4:A4,0x100)
...
TracerRegisterReactions(self+0x3c19,B7:B8,0x102;self+0x3d01,B8:B7,0x100)
EnableReaction(Z1)
EnableReaction(A3)
EnableReaction(A4)
EnableReaction(A5)
