...
TracerRegisterReactions(self+0x1317,A1:A2,0x100;EAX+0x9ab,A2:ST:B1:B5:U1,0x100;EDI,ST,0x0;EDI,U1,0x201)
DisableReactions
EnableReaction(A1)
...
decision:
Decision=(RE:re,B1:overwrite,B5:overwrite2,default:loop)
