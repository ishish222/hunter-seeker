...
# exploring reactions
TracerRegisterReactions(EDI+0x3e7d,B1:B2,0x102;EDI+0x3e7f,B2:B1,0x100)
TracerRegisterReactions(EDI+0x285f,B3:B4,0x102;EDI+0x2861,B4:B3,0x100)
TracerRegisterReactions(self+0x1317,A1:A2,0x100;EAX+0x9ab,A2:ST:B1:B3:U1,0x100;EDI,ST,0x0;EDI,U1,0x201)
DisableReactions
EnableReaction(A1)
