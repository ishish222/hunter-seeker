...
prototypes['QemuQuickLoad']         = qemu_parts.qemu_quick_load
prototypes['QemuLoad']              = qemu_parts.qemu_load
prototypes['QemuQuickSave']         = qemu_parts.qemu_quick_save
...
prototypes['ScheduleCmd']                = responder_parts.schedule_cmd
prototypes['ScheduleCommand']                = responder_parts.schedule_cmd
...
prototypes['TracerReadDebugLog']    = tracer_parts.tracer_read_debug_log
prototypes['DebugLogEnable']        = tracer_parts.tracer_debug_log_enable
prototypes['ReadDebugLog']          = tracer_parts.tracer_read_debug_log
