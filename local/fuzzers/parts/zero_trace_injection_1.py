...
TracerManualSt = statemachine.State()
TracerManualSt.name = "Setting A1 marker"
TracerManualSt.args = "A1"
TracerManualSt.executing_routine = usualparts.tracer_parts.tracer_enable_reaction
...
TracerEnableBasic = statemachine.State()
TracerEnableBasic.name = "Enabling basic reactions"
TracerEnableBasic.executing_routine = usualparts.tracer_parts.tracer_enable_anchors

TracerEnableDebug1 = statemachine.State()
TracerEnableDebug1.name = "Enabling reaction"
TracerEnableDebug1.args = "P1"
...
### Decision: RR
TracerManualSt.consequence            = TracerDebugContinueInf

### Decision: RB - ST
TracerEnableBasic.consequence    = DumpMemory
