...
while True:
    try:
        if(check_d_sect()):
            ...
            sect.decode()
            print("--")
            print("Data section, no: " + hex(sect.number))
            print("Signature: " + hex(sect.signature))
            print("Offset: " + hex(sect.offset))
            print("cSize: " + hex(sect.cSize))
            print("dSize: " + hex(sect.dSize))
            print("Data offset: " + hex(sect.dataOffset))
            cCur += sect.dSize
        else:
            if(check_s_sect()):
